...
from fastapi_app.pricing_page import router as pricing_router  # Import the router from pricing_page.py

from fastapi.middleware.cors import CORSMiddleware #for react
